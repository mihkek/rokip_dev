...
<div class="modal fade" id="modal_{{ $id }}_credit">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ isset($item) ? route('admin.langs.update',$item) : route('admin.langs.store') }}" class="was-validated" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body text-left">
                    @include('admin._include.form.input',['data'=>'key','label'=>'Ключ','required'=>true])
