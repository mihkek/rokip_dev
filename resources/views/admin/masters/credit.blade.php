    ...
    <div class="content-wrapper mt-2">
        <section class="content">
            <div class="card card-outline card-primary">
                <form class="was-validated" action="{{ isset($item) ? route('admin.masters.update',$item) : route('admin.masters.store') }}" method="POST" >
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('admin.users.create') }}" class="btn btn-outline-primary btn-sm text-primary mr-2">
                                Создать нового
                            </a>
                        </div>
                    </div>
